...
subgroups = ["[{'age': 0, 'sex': 0}][{'age': 1, 'sex': 0}]","[{'age': 1, 'sex': 0}][{'age': 0, 'sex': 1}]",
             "[{'age': 0, 'sex': 1}][{'age': 1, 'sex': 1}]","[{'age': 0, 'sex': 0}][{'age': 0, 'sex': 1}]",
             "[{'age': 1, 'sex': 0}][{'age': 1, 'sex': 1}]","[{'age': 0, 'sex': 0}][{'age': 1, 'sex': 1}]"]
sg = ["{'age': 0, 'sex': 0}", "{'age': 1, 'sex': 0}", "{'age': 0, 'sex': 1}",
      "{'age': 1, 'sex': 1}"]
...
for clf in classifiers:
    ...
    for i in range(10):
        ...
        #extra insight about the privileged and unprivileged group structure
        ...
        cntr, u_orig, _, _, _, _, _ = fuzz.cluster.cmeans(alldata, 3, 2, error=0.005, 
                                                          maxiter=5000)
        ...
        # plot_tsne(X_train_reduc, clusters, 60, 80)
